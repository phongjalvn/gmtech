								...
								<div class="yt_category_inner yt_clearfix">
									...
									<?php if( count($other) > 0 ): ?>
										<ul>
											...
											?>
											<li><a href="<?php echo $item->url; ?>" <?php echo $attrs; ?> <?php echo YtUtils::getTargetAttr($options->other_items_link_target); ?>><?php echo $item->full_title; ?></a> <span class="created"><?php echo $item->createdfrom; ?></span></li>
											<?php endforeach; ?>
										</ul>
									<?php endif; ?>
										<div class="yt_browsers yt_clearfix">
											<div class="btn cat_<?php echo $category->id; ?> yt_clearfix">
											...
											<div class="btn cat_<?php echo $section->id; ?> yt_clearfix">
