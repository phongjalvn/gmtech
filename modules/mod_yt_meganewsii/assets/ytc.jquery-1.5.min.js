 ...
 */
if(typeof(jQuery)=='function'){ if(jQuery.fn.jquery!='1.5'){ var jQueryAnother = jQuery; }}; // backup jQuery if exists
...
if (!$jYtc) { var $jYtc = jQuery.noConflict(); } // create noConflict instance
if (jQueryAnother){ jQuery = jQueryAnother; }; // restore if have backup