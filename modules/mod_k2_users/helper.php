<?php
/**
 * @version		$Id: helper.php 1322 2011-11-21 11:16:57Z lefteris.kavadas $
 * @package		K2
...
class modK2UsersHelper {
	...
	function getUsers(&$params){
		...
		if(K2_JVERSION=='16'){
			$itemAccessCheck = " i.access IN(".implode(',', $user->authorisedLevels()).") ";
			$categoryAccessCheck = " c.access IN(".implode(',', $user->authorisedLevels()).") ";
			$languageCheck = '';
