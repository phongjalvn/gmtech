...
class NSP_GK4_Portal_Mode_3 {
	...
	function output() {
		...
		for($i = 0; $i < count($this->parent->content["ID"]); $i++) {	
			...
			$news_title_content = '<div class="nsp_title_tab"><div class="nsp_date">' . $news_date . '</div><div class="nsp_title">'.$this->parent->content['title'][$i].'</div></div>';
			...
			$news_generated_content = '<div class="nsp_art_more unvisible"><div class="nsp_art_main">' . $news_generated_content . '</div></div>';
