...
<script type="text/javascript" src="<?php echo $uri->root(); ?>modules/mod_news_pro_gk4/interface/scripts/engine.portal.mode.3.js"></script>
<?php endif; ?>
...
$Gavick["nsp-<?php echo $this->parent->config['module_id'];?>"] = {
	...
	"open_first": <?php echo $this->parent->config['news_portal_mode_3_open_first']; ?>
};
//]]>
</script>	