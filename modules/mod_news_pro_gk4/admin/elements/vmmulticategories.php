...
class JElementVMMultiCategories extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name) {
        ...
        $db =& JFactory::getDBO();
        // generating query
		$db->setQuery("SELECT c.category_name AS name, c.category_id AS id, x.category_parent_id AS parent FROM #__vm_category AS c LEFT JOIN #__vm_category_xref AS x ON x.category_child_id = c.category_id WHERE c.category_publish = 'Y' ORDER BY c.category_name, x.category_parent_id ASC");
 		// getting results
