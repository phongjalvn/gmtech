...
class JElementMultiSections extends JElement
{
	// name of element
	var $_name = 'MultiSections';
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
        ...
        $db =& JFactory::getDBO();
        // generating query
		$db->setQuery("SELECT s.title AS name, s.id AS id FROM #__sections AS s WHERE s.published = 1 ORDER BY s.title");
 		// getting results
