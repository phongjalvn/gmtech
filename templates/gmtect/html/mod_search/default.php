...
<form action="index.php" method="post">
	<div class="search-index<?php echo $params->get('moduleclass_sfx') ?>">
		<?php
			...
			if ($button) :
			    if ($imagebutton) :
			        ...
			        $button = '<input id="search_submit" type="submit" value="'.$button_text.'" class="button'.$moduleclass_sfx.'" onclick="this.form.searchword.focus();"/>';
			    endif;
			endif;
