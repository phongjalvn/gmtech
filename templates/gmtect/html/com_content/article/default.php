...
<div class="joomla <?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
	...
	<div class="article">
		...
		//	$iArray = array(3,4);
		?>
		<?php //if(in_array($catID,$iArray)) :?>
		<?php 
		//	$lang = $_GET['lang'];
//			if($lang==null) $lang = 'vi';
//			if($lang=='vi') $image_dattour = 'dattourvi.png';
//			else $image_dattour = 'dattouren.png';
		?>
	<!--	<div class="dat_tour"><a href="index.php?option=com_rsform&Itemid=34&lang=<?php //echo $lang?>"><img src="templates/vietprotocol/images/<?php //echo $image_dattour?>" border="0"/></a></div>-->
		<?php //endif;?>
	</div>
	</div>
	<div class="out_article"><?php echo $this->article->event->afterDisplayContent; ?></div>
</div>