...
$document->addStyleSheet(JURI::root().'components/com_k2/templates/k2tabberfree/includes/k2tabber.css');

$paramsdata = $this->item->category->plugins;
$paramsplug = new JParameter( $paramsdata );
?>
  ...
  <div class="itemBody">
	  ...
	  <!-- Item extra fields -->
		...
		<div class="simpleTabs">
	  	<ul class="simpleTabsNavigation" style="<?php echo $paramsplug->get('tabberfreeulstyle_free'); ?>">
			<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
			<?php if($extraField->value): ?>
			<li>
				<a href="javascript: void();" style="<?php echo $paramsplug->get('tabberfreeastyle_free'); ?>"><?php echo $extraField->name; ?></a>
			...
			<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
			<?php if($extraField->value): ?>
			<div class="simpleTabsContent" style="<?php echo $paramsplug->get('tabberfreecontentstyle_free'); ?>">
