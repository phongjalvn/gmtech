...
class JK2AdminCSSMenu extends JTree
{
	/**
	...
	{
		$this->_root = new JK2MenuNode('ROOT');
		$this->_current = & $this->_root;
	}

	function addSeparator()
	{
		$this->addChild(new JK2MenuNode(null, null, 'separator', false));
	}
...
class JK2MenuNode extends JNode
{
	/**
	 * Node Title
	 */
