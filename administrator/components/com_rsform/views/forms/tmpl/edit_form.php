	...
	<tr>
		<td valign="top" align="left" width="1%">
			<table>
				...
				<tr>
					<td width="80" align="right" nowrap="nowrap" class="key"><?php echo JText::_('RSFP_SAVE_TO_DATABASE'); ?></td>
					<td><?php echo $this->lists['keepdata']; ?></td>
				</tr>
				<tr>
					<td width="80" align="right" nowrap="nowrap" class="key"><?php echo JText::_('RSFP_CONFIRM_SUBMISSION'); ?></td>
					<td><?php echo $this->lists['confirmsubmission']; ?></td>
				</tr>
				<tr>
					<td width="80" align="right" nowrap="nowrap" class="key"><?php echo RSFormProHelper::translateIcon(); ?> <?php echo JText::_('RSFP_FORM_TITLE'); ?></td>
				...
				<tr>
					<td width="80" align="right" nowrap="nowrap" class="key"><?php echo RSFormProHelper::translateIcon(); ?> <?php echo JText::_('RSFP_THANKYOU'); ?></td>
					<td>
				...
				<tr>
					<td width="80" align="right" nowrap="nowrap" class="key"><?php echo RSFormProHelper::translateIcon(); ?>  <?php echo JText::_('RSFP_ERROR_MESSAGE'); ?></td>
					<td>
