...
<table class="admintable">
	<tr>
		<td width="160" style="width: 160px;" align="right" class="key"><?php echo RSFormProHelper::translateIcon(); ?> <?php echo JText::_('RSFP_META_DESC'); ?></td>
	...
	<tr>
		<td width="160" style="width: 160px;" align="right" class="key"><?php echo RSFormProHelper::translateIcon(); ?> <?php echo JText::_('RSFP_META_KEY'); ?></td>
