	...
	<tr>
		<td width="1%" valign="top">
		   <table width="100%" style="clear:both;">
				<tr>
					<td width="1%">
						<textarea class="codemirror-html" name="FormLayout" id="formLayout" <?php echo $this->form->FormLayoutAutogenerate ? 'readonly="readonly"' : '';?>><?php echo $this->escape($this->form->FormLayout); ?></textarea>
					</td>
					<td valign="top">
					</td>
				</tr>
