...
class plgSystemAdvancedModules extends JPlugin
{
	...
	function onAfterRoute()
	{
		...
		if ( !JFile::exists( JPATH_ADMINISTRATOR.'/components/com_advancedmodules/admin.advancedmodules.php' ) ) {
			return;
		}
...
function &plgSystemAdvancedModulesConfig()
{
	...
	if ( !is_object( $instance ) ) {
		...
		$instance = $parameters->getParams( $config->_raw, JPATH_ADMINISTRATOR.'/components/com_advancedmodules/config.xml' );
	}
	return $instance;
}
